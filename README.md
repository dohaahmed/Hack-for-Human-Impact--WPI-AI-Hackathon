# Hack-for-Human-Impact--WPI-AI-Hackathon
Water Quality &amp; Community Health Project: exploring environmental measurements (such as dissolved oxygen, pH, temperature, and conductivity) collected across Massachusetts. Identify patterns that reveal risk, stress, resilience, or opportunity for healthier, more equitable communities. 
...
For comprehensive documentation, see PROJECT_DOCUMENTATION.md which includes:
...
For DOR data integration details, see DOR_DATA_INTEGRATION.md
